...
class DashBoardSearch {
    ...
    public function search() {
        ...
        $ativos = Ativo::find()
                ->select(['ativo.codigo', 'sum(valor_bruto) as valor_bruto', 'ativo.categoria', 'valor_categoria', 'ativo.pais', 'valor_pais', 'ativo.tipo', 'valor_tipo', 'valor_acao_pais'])
                ...
                ->where(['ativo' => true])
                ->groupBy(['ativo.codigo', 'ativo.categoria', 'valor_categoria', 'ativo.pais', 'valor_pais', 'ativo.tipo', 'valor_tipo', 'valor_acao_pais']);
